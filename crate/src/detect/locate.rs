...
///
/// Takes borrowed segments rather than owned ones: every caller holds a
/// stack it is still using, and copying each segment to read it is a
/// clone per finding on the file this tool is aimed at most.
